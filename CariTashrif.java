 ...
 * @author Hannati
 */
public class CariTashrif extends javax.swing.JFrame {

    /**
     * Creates new form CariTashrif
     */
    public CariTashrif() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cari Tashrif");

        jLabel2.setText("Wazan");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        TampilCari frm = new TampilCari();
        frm.getJLabel1().setText(InputCari.getText());
        frm.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariTashrif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
